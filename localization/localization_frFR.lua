local L = LibStub("AceLocale-3.0"):NewLocale("CustomAchiever", "frFR", false)

if L then

L["CUSTOMACHIEVER_WELCOME"] = "Tapez /custac pour afficher Custom Achiever."

L["SPACE_BEFORE_DOT"] = " "

L["GENERAL_SECTION"] = "Options générales"
L["ENABLE_SOUND"] = "Sons actifs"
L["ENABLE_SOUND_DESC"] = "Active / désactive les sons de Custom Achiever"
L["ENABLE_ACHIEVEMENT_ANNOUNCE"] = "Annonce des Hauts faits"
...
L["MENUCUSTAC_CAT_CONFIRM_DELETION"] = "Voulez-vous vraiment effacer définitivement la Catégorie |cff00ff00%s|r ?"
L["MENUCUSTAC_CAT_CONFIRM_DELETION_MOVE"] = "Les Hauts faits de cette catégorie seront déplacés dans |cff00ff00%s|r."
L["MENUCUSTAC_CAT_CONFIRM_DELETION_LOST"] = "Les Hauts faits de cette catégorie seront perdus."
...
L["SHARECUSTAC_NOACKNOWLEDGMENT"] = "%s ne semble pas avoir Custom Achiever ou est hors ligne."

L["MENUOPTIONS_TOOLTIP"] = "Options de Custom Achiever"
L["MENUOPTIONS_TOOLTIPDETAIL"] = "Modifier les options de Custom Achiever."

L["CUSTAC_ACH_DELETION"] = "Supprimer le haut fait personnalisé"
L["CUSTAC_CAT_DELETION"] = "Supprimer la catégorie de hauts faits personnalisés"
